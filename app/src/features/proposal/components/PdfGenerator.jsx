      ...
      try {
        if (isArmazem) {
          const data = {
            ...
            modoProposta: meta.opcionais?.modoProposta || 'completo',
            itens: meta.opcionais?.itens ?? meta.itens ?? [],
            quantidadeMaterialEstimada: meta.opcionais?.quantidadeMaterialEstimada ?? meta.quantidadeMaterialEstimada ?? '',
            descricaoRecomendacaoMaterial: meta.opcionais?.descricaoRecomendacaoMaterial ?? meta.descricaoRecomendacaoMaterial ?? '',
